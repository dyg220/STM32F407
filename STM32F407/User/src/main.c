...
void HSVtoRGB(uint16_t h, uint8_t *r, uint8_t *g, uint8_t *b) {
	...
	switch (sector) {
	case 0: *r = 255; *g = t;    *b = p;    break; // 红→黄
	case 1: *r = q;    *g = 255; *b = p;    break; // 黄→绿
	case 2: *r = p;    *g = 255; *b = t;    break; // 绿→青
	case 3: *r = p;    *g = q;    *b = 255; break; // 青→蓝
	case 4: *r = t;    *g = p;    *b = 255; break; // 蓝→紫
	case 5: *r = 255; *g = p;    *b = q;    break; // 紫→红
	default: *r = 255; *g = 0;    *b = 0;    break; // 错误情况
	}
}
